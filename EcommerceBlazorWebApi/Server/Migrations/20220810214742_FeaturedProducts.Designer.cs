...
namespace EcommerceBlazorWebApi.Server.Migrations
{
    ...
    [Migration("20220810214742_FeaturedProducts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceBlazorWebApi.Shared.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceBlazorWebApi.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceBlazorWebApi.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("EcommerceBlazorWebApi.Shared.Product", b =>
                {
                    b.HasOne("EcommerceBlazorWebApi.Shared.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("EcommerceBlazorWebApi.Shared.ProductVariant", b =>
                {
                    b.HasOne("EcommerceBlazorWebApi.Shared.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EcommerceBlazorWebApi.Shared.ProductType", "ProductType")
                        .WithMany()
